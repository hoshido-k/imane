#!/bin/bash
# 本番環境用のiOSシミュレーター起動スクリプト

set -e

echo "Running imane mobile app on SIMULATOR with PRODUCTION environment..."
echo "====================================================================="
...
echo ""
echo "App launched successfully on simulator with production backend!"
