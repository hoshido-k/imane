...
from app.api.v1 import auth, friends, notifications, pops, reactions, users
...
app.include_router(pops.router, prefix="/api/v1/pops", tags=["ポップ"])
app.include_router(reactions.router, prefix="/api/v1/reactions", tags=["リアクション"])
